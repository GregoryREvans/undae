...
maker = evans.SegmentMaker(
    ...
    commands=[
        ...
        evans.MusicCommand(
            ...
            evans.slur([4]),
            evans.text_span([r"scr.", r"norm."], "=>", padding=2, id=1),
        ...
        evans.MusicCommand(
            ...
            evans.trill(alteration="+P4", harmonic=True, padding=7),
            evans.Attachment(
                abjad.Markup(r"\markup scr."),
        ...
        evans.MusicCommand(
            ...
            evans.text_span([r"norm.", "scr."], "=>", padding=2, id=1),
            evans.text_span([r"T", r"P"], "=>", padding=4, id=2),
            undae.D_color,
        ),
        evans.MusicCommand(
